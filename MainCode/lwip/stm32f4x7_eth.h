...
/*bit field registers*/
#define SYNC_1STEP     0x8000
#define TX_IPV4_EN     0x0020
#define TX_PTP_VER_2   0x0004
#define TX_TS_EN       0x0001
#define IP1588_EN      0x0100
#define IGNORE_2STEP   0x0800
#define RX_IPV4_EN     0x0020
#define RX_PTP_VER_2   0x0004
#define RX_TS_EN       0x0001
#define IP1588_EN2     0x0400
#define IP1588_EN1     0x0200
#define IP1588_EN0     0x0100
#define TS_INSERT			 0x0100
#define ACC_UDP        0x0800
#define ACC_CRC        0x4000
#define TS_SEC_EN			 0x4000
#define RXTS_NS_OFF_16 0x0800
#define RXTS_SEC_OFF_5 0x0005
#define PTP_ENABLE     0x0004
#define PTP_DISABLE    0x0002
#define PTP_RD_CLK		 0x0020
#define PTP_LOAD_CLK   0x0010
#define PTP_RATE_DIR   0x8000
#define PTP_CLKOUT_EN  0x8000
#define PTP_CLKOUT_SEL 0x4000
#define CLK_OUT_DIS    0x0002
#define TXTS_RDY  		 0x0800
#define RXTS_RDY       0x0400
#define TRIG_DONE      0x0200
#define EVENT_RDY      0x0100
#define MASK_EVENT_FL  (TXTS_RDY | RXTS_RDY | TRIG_DONE | EVENT_RDY)
#define TRIG_SEL_SHIFT 10
#define TRIG_LOAD      0x0040
#define TRIG_READ			 0x0080
#define TRIG_EN        0x0100
#define TRIG_DIS       0x0200
#define TRIG_GPIO_SHIFT    8
#define TRIG_CSEL_SHIFT    1
#define TRIG_WR        0x0001
#define TRIG_PULSE     0x8000
#define TRIG_NOTIFY    0x1000
#define TRIG2_ERROR    0x20
/*PHY_Register_address */
#define PAGESEL             19            /*Page Select Register */
#define PTP_TXCFG1					0x17					/*PTP Transmit Configuration Register 1*/
#define PTP_TXCFG_PAGE			5
#define PTP_TXCFG0					0x16					/*PTP Transmit Configuration Register 0*/
#define PTP_RXCFG0          0x19					/*PTP Receive Configuration Register 0*/
#define PTP_RXCFG_PAGE			5
#define PTP_RXCFG1					0x1A					/*PTP Receive Configuration Register 1*/
#define PTP_RXCFG3          0x1C					/*PTP Receive Configuration Register 3*/
#define PTP_RXCFG4          0x1D					/*PTP Receive Configuration Register 4*/
#define PTP_CTL							0x14					/*PTP Control Register*/
#define PTP_CTL_PAGE				4
#define PTP_TDR							0x15					/*PTP Time Data Register*/
#define PTP_TDR_PAGE        4
#define PTP_RATEH						0x19					/*PTP Rate High Register*/
#define PTP_RATEL					  0x18					/*PTP Rate Low Register*/
#define PTP_RATE_PAGE       4					
#define PTP_COC             0x14          /*PTP Clock Output Control Register*/
#define PTP_COC_PAGE        6
#define PHYCR2              0x1C          /*PHY Control Register 2*/
#define PTP_PHYCR2_PAGE     0
#define PTP_STS							0x16          /*PTP Status Register*/
#define PTP_STS_PAGE        4
#define PTP_TXTS						0x1C					/*PTP Transmit Timestamp Register*/
#define PTP_TXTS_PAGE       4
#define PTP_RXTS						0x1D					/*PTP Receive Timestamp Register*/
#define PTP_RXTS_PAGE       4
#define PTP_TRIG						0x14					/*PTP Trigger Configuration Register*/
#define PTP_TRIG_PAGE       5
#define PTP_TSTS            0x17          /*PTP Trigger Status Register*/
#define PTP_TSTS_PAGE       4
#define PTP_CLKSRC          0x1B          /*PTP Clock Source Register*/
#define PTP_CLKSRC_PAGE     6  
#define PTP_GPIOMON					0x1E					/*PTP GPIO Monitor Register*/
#define PTP_GPIOMON_PAGE    6
/*functions*/
...
void PTPGetReceivTimestamp(uint16_t PHYAddress, uint32_t *sec, uint32_t *nsec, uint32_t *overflowCount, uint32_t *sequenceId, uint8_t *messageType, uint32_t *hashValue);
